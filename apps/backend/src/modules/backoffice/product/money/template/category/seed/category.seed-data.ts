...
export const CATEGORY_TEMPLATE_SEED = [
    ...
    { key: 'PHARMACY', name: 'Pharmacy', jarKey: JarKey.NECESSITIES, icon: '💊' },
    { key: 'DRUGSTORE', name: 'Drugstore', jarKey: JarKey.NECESSITIES, icon: '🧴' },
    { key: 'NUTRITION', name: 'Nutrition', jarKey: JarKey.NECESSITIES, icon: '🥗' },
    { key: 'MEDICAL', name: 'Medical', jarKey: JarKey.NECESSITIES, icon: '🏥' },
    { key: 'THERAPY', name: 'Therapy', jarKey: JarKey.NECESSITIES, icon: '🧠' },
