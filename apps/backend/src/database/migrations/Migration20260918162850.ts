...
export class Migration20260918162850 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "money_transaction" add column "applied_merchant_key" varchar(64) null;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "money_transaction" drop column "applied_merchant_key";`);
