...
const soul = {
    ...
    gratitude: {
        ...
        add: 'Add',
        empty: 'Nothing written yet. The week check will ask you here.',
        delete_aria: 'Delete',
    ...
    giving: {
        ...
        empty_auto: 'Nothing leaves the Give jar automatically yet.',
        no_org: 'No organisation named yet',
        received_year: 'Received this year',
        empty_ledger: 'No sorted giving in the ledger yet this year.',
        to_whom: 'To whom',
